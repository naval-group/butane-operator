...
//+kubebuilder:rbac:groups=butane.coreos.com,resources=butaneconfigs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=butane.coreos.com,resources=butaneconfigs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=butane.coreos.com,resources=butaneconfigs/finalizers,verbs=update
